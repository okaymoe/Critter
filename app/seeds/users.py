...
def seed_users():
    demo = User(
        username='demopuppy', name="Demo Puppy", bio='Just taking a sniff of this website...I like it!', profile_img='https://pbs.twimg.com/profile_images/1552995729014247425/TaJbIdmK_400x400.jpg', header_img='https://www.allandetrobert.com/wp-content/uploads/2017/09/header-pet-food.jpg', email='demo@aa.io', password='password', birthday='March 13th, 1995', joined='2019-03-17 12:12:22')
    marnie = User(
